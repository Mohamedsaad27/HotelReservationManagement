...
SELECT * FROM Customer WHERE room_id in (SELECT room_id FROM Room WHERE number_of_bids > 2) ;
...
SELECT * FROM Customer WHERE room_id in (SELECT room_id FROM Room WHERE price > 100 or number_of_bids > 2) ;
